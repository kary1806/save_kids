...
export default function GoogleButton() {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex w-full items-center justify-center gap-2 rounded-2xl border border-hairline px-6 py-3 font-instrument text-black transition-transform duration-200 hover:scale-[1.02] active:scale-95"
    >
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
        ...
        <path
          fill="#FBBC05"
          d="M5.27 14.27c-.24-.72-.38-1.49-.38-2.27s.14-1.55.38-2.27V6.62H1.26A11.97 11.97 0 0 0 0 12c0 1.93.46 3.76 1.26 5.38l4.01-3.11z"
        />
        <path
          fill="#EA4335"
